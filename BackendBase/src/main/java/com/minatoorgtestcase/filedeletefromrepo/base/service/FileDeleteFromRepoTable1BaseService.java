package com.minatoorgtestcase.filedeletefromrepo.base.service;
...
import com.minatoorgtestcase.filedeletefromrepo.base.model.FileDeleteFromRepoTable1Base;
import java.util.List;
...
public class FileDeleteFromRepoTable1BaseService<T extends FileDeleteFromRepoTable1Base> extends BaseBusinessLogic<T>
		implements IFileDeleteFromRepoTable1BaseService<T> {
		
	private static final Logger LOGGER = LoggerFactory.getLogger(FileDeleteFromRepoTable1BaseService.class.getName());
	...
	@Autowired
	private  FileDeleteFromRepoTable1PerimeterBaseImpl filedeletefromrepotable1PerimeterBaseImpl;
	
	
	public FileDeleteFromRepoTable1BaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("FileDeleteFromRepoTable1", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("FileDeleteFromRepoTable1", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("FileDeleteFromRepoTable1", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	protected IPerimeterManager<T> getPerimeterManager() {
		return filedeletefromrepotable1PerimeterBaseImpl;
	}
}