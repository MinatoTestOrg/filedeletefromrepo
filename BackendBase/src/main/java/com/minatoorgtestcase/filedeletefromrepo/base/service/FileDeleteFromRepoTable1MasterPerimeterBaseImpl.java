...
import com.minatoorgtestcase.filedeletefromrepo.base.model.constants.FileDeleteFromRepoTable1MasterConstantBase;
...
@Component
public abstract class FileDeleteFromRepoTable1MasterPerimeterBaseImpl<T extends FileDeleteFromRepoTable1MasterBase> implements IPerimeterManager<T>, FileDeleteFromRepoTable1MasterConstantBase {
	
	private Logger LOGGER = LoggerFactory.getLogger(FileDeleteFromRepoTable1MasterPerimeterBaseImpl.class);
