...
import com.minatoorgtestcase.filedeletefromrepo.base.service.IFileDeleteFromRepoTable1BaseService;
...
public abstract class FileDeleteFromRepoTable1BaseController<SERVICE extends IFileDeleteFromRepoTable1BaseService<M>, M extends FileDeleteFromRepoTable1Base>
		extends BaseWebService<SERVICE, M> {
	
	
	public FileDeleteFromRepoTable1BaseController(SERVICE logic) {
		super(logic);
	}
	
	
	@PreAuthorize("hasAccess('/filedeletefromrepotable1s/{ids}')")
	@DeleteMapping("/{ids}")
	...
	@PreAuthorize("hasAccess('/filedeletefromrepotable1s/autosuggest')")
	...
	@PreAuthorize("hasAccess('/filedeletefromrepotable1s/{sid}')")
	...
	@PreAuthorize("hasAccess('/filedeletefromrepotable1s/')")
	@PutMapping
	...
	@PreAuthorize("hasAccess('/filedeletefromrepotable1s/datatable')")
