...
export class AppLayoutBaseService {
  ...
  config : any = {"left":[{"element":"logo"},{"menuType":"fixed","hideSidebarOnCollapse":false,"element":"leftMenu"},{"element":"appTitle"}],"middle":[{"element":"leftPane"},{"element":"middlePane"},{"element":"rightPane"}],"right":[{"children":[{"element":"logout"}],"element":"user"},{"menuType":"float","element":"rightMenu"},{"menuType":"float","element":"navigationTabs"}]};
