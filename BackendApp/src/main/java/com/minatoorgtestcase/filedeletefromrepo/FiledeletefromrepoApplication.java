package com.minatoorgtestcase.filedeletefromrepo;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatoorgtestcase.filedeletefromrepo"})
@EnableCaching
...
public class FiledeletefromrepoApplication {

	public static void main(String[] args) {
		SpringApplication.run(FiledeletefromrepoApplication.class, args);
	}
